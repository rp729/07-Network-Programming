...
===================================================================================================================
2) Scraping Numbers from HTML using python modules. In this assignment you will write a Python program similar to
http://www.py4e.com/code3/urllink2.py. The program will read the HTML from the data files below, and parse the data,
